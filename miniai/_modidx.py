...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'miniai.accel': { 'miniai.accel.AccelerateCB': ('ddpm_v2.html#acceleratecb', 'miniai/accel.py'),
            ...
            'miniai.augment': { 'miniai.augment.CapturePreds': ('augment.html#capturepreds', 'miniai/augment.py'),
                                ...
                                'miniai.augment.RandSwap': ('augment.html#randswap', 'miniai/augment.py'),
                                'miniai.augment.RandSwap.__init__': ('augment.html#randswap.__init__', 'miniai/augment.py'),
                                'miniai.augment.RandSwap.forward': ('augment.html#randswap.forward', 'miniai/augment.py'),
                                ...
                                'miniai.augment._rand_swap1': ('augment.html#_rand_swap1', 'miniai/augment.py'),
                                'miniai.augment.get_rand_rect_start': ('augment.html#get_rand_rect_start', 'miniai/augment.py'),
                                ...
                                'miniai.augment.rand_swap': ('augment.html#rand_swap', 'miniai/augment.py'),
            ...
            'miniai.diffusion': { 'miniai.diffusion.DownBlock': ('diffusion-attn-cond.html#downblock', 'miniai/diffusion.py'),
                                  ...
                                  'miniai.diffusion.EmbUNetModel.forward': ( 'diffusion-attn-cond.html#embunetmodel.forward',
                                                                             'miniai/diffusion.py'),
                                  'miniai.diffusion.SaveConv': ('diffusion-attn-cond.html#saveconv', 'miniai/diffusion.py'),
                                  'miniai.diffusion.SaveEmbResBlock': ('diffusion-attn-cond.html#saveembresblock', 'miniai/diffusion.py'),
                                  'miniai.diffusion.SaveModule': ('diffusion-attn-cond.html#savemodule', 'miniai/diffusion.py'),
                                  'miniai.diffusion.SaveModule.forward': ( 'diffusion-attn-cond.html#savemodule.forward',
                                                                           'miniai/diffusion.py'),
                                  ...
                                  'miniai.diffusion.add_noise': ('diffusion-attn-cond.html#add_noise', 'miniai/diffusion.py'),
                                  'miniai.diffusion.batch_to_heads': ('diffusion-attn-cond.html#batch_to_heads', 'miniai/diffusion.py'),
                                  ...
                                  'miniai.diffusion.heads_to_batch': ('diffusion-attn-cond.html#heads_to_batch', 'miniai/diffusion.py'),
                                  ...
                                  'miniai.diffusion.timestamp_embedding': ( 'diffusion-attn-cond.html#timestamp_embedding',
                                                                            'miniai/diffusion.py'),
            ...
            'miniai.fid': { 'miniai.fid.ImageEval': ('fid.html#imageeval', 'miniai/fid.py'),
                            ...
                            'miniai.fid.ImageEval._get_feats': ('fid.html#imageeval._get_feats', 'miniai/fid.py'),
                            ...
                            'miniai.fid.capture_preds': ('fid.html#capture_preds', 'miniai/fid.py')},
            'miniai.init': { 'miniai.init.BatchTransformCB': ('initializing.html#batchtransformcb', 'miniai/init.py'),
                             ...
                             'miniai.init.LsuvCB': ('initializing.html#lsuvcb', 'miniai/init.py'),
                             'miniai.init.LsuvCB.__init__': ('initializing.html#lsuvcb.__init__', 'miniai/init.py'),
                             'miniai.init.LsuvCB.before_fit': ('initializing.html#lsuvcb.before_fit', 'miniai/init.py'),
                             'miniai.init.LsuvCB.reset': ('initializing.html#lsuvcb.reset', 'miniai/init.py'),
            ...
            'miniai.learner': { 'miniai.learner.Callback': ('learner.html#callback', 'miniai/learner.py'),
                                ...
                                'miniai.learner.ProgressCB._update_graph': ('learner.html#progresscb._update_graph', 'miniai/learner.py'),
                                ...
                                'miniai.learner.ProgressCB.log': ('learner.html#progresscb.log', 'miniai/learner.py'),
